        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-cream/70">
              ...
              <li>Phone: <a href="tel:+923127370957" className="hover:text-gold">+92 312 7370957</a></li>
              <li>WhatsApp: <a href="https://wa.me/923127370957" target="_blank" rel="noopener noreferrer" className="hover:text-gold">+92 312 7370957</a></li>
              <li>TODO_ADDRESS</li>
            </ul>
          </div>
        </div>
